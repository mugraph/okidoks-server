...
type Contributor struct {
	...
	ContributorRoles []ContributorRole `json:"contributorRoles" gorm:"foreignKey:ContributorID"` // List of roles assumed by the contributor when working on the resource.
